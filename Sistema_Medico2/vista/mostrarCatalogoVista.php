...
<body>
   ...
   <main id="main" class="main">
     ...
     <div class="section">
      ...
      <div class="table-responsive">
        <table class="table table-light table-bordered" id="tablacatalago">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Información Antecedentes</h5>
          ...
          <div class="modal-body">
            <div class="col-md-12">
                ...
                <div class="col-12">
                  ...
                  <input class="form-control" id="descripcionPato" disabled name='descripcionPatologia' type='email' placeholder="Correo Electronico"/>
                  <span class="d-block small opacity-50" id="errorCo"></span>
                </div>
                <div class="col-12">
                  <label class="form-label">Habito Psicobiologico</label>
                  <input class="form-control" id="descripcionHabi" disabled name='descripcionHabPsico' type='number'/>
                  <span class="d-block small opacity-50" id="errorTele"></span>
                </div>
                <div class="col-md-12">
                  <label class="form-label">Antecedente Familiar</label>
                  <input type="date" class="form-control" id="descripcionAnte" disabled name='descripcionAntFam'/>
 ...
 <div class="modal fade" id="reporte" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <div class="m-5 text"><h5 align="center">¿Desea Descagar el Reporte?</h5></div>
                 ...
                 <div class="text-center">
                  <button  type="submit" name='reporte' class="btn btn-primary" id="pd">Descargar</button>
                  </button>
                </div>
                </form>
          </div>
        ...
        <script src="assets/js/Catalago/consultaModalCatalago.js"></script> 
    </body>
</html>